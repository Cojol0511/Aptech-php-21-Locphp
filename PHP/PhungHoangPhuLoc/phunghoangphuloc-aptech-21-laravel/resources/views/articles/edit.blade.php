...
<body>
    <form action="{{route('articles.update',$article->id)}}" method="POST">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" value="{{$article->title_slug}}" name="title_slug">
        </div>
        <div>
        <textarea name="description" class="form-control " id="ckeditor">{!! $article->description !!}</textarea>
        </div>
